...
const SEED_USERS = [
    ...
    {
        user_id:       'seed_usr_song_lg',
        email:         'seed_song_lg@seed.refresheet.local',
        employee_name: '오늘도야근각',
        company:       'LG전자',
        source:        'seed',
        commute_start: '09:00',
        commute_end:   '19:00',
    ...
    {
        user_id:       'seed_usr_han_sk',
        email:         'seed_han_sk@seed.refresheet.local',
        employee_name: '상무님이봐요',
        company:       'SK하이닉스',
        source:        'seed',
        commute_start: '08:30',
        commute_end:   '17:30',
    ...
    {
        user_id:       'seed_usr_baek_coupang',
        email:         'seed_baek_coupang@seed.refresheet.local',
        employee_name: '로켓배송중',
        company:       '쿠팡',
        source:        'seed',
        commute_start: '09:00',
    ...
    {
        user_id:       'seed_usr_woo_baemin',
        email:         'seed_woo_baemin@seed.refresheet.local',
        employee_name: '배달비가아까워',
        company:       '배달의민족',
        source:        'seed',
        commute_start: '10:00',
        commute_end:   '19:00',
        profile: {
            label:        '저녁형',
            playHoursKST: [18, 19],
            preferredGames: ['typing_game', '2048'],
            skillLevel:   'mid_high',
            activeDays:   'weekday',
            playFreq:     0.60,
            maxPerDay:    4,
    ...
    {
        user_id:       'seed_usr_shin_toss',
        email:         'seed_shin_toss@seed.refresheet.local',
        employee_name: '토스뱅커에요',
        company:       '토스',
        source:        'seed',
        commute_start: '09:00',
        commute_end:   '18:00',
        profile: {
            label:        '오전집중형',
            playHoursKST: [9, 10, 11],
            preferredGames: ['sudoku', 'sudoku', 'sudoku'],
            skillLevel:   'high',
            activeDays:   'weekday',
            playFreq:     0.70,
            maxPerDay:    5,
    ...
    {
        user_id:       'seed_usr_ahn_carrot',
        email:         'seed_ahn_carrot@seed.refresheet.local',
        employee_name: '당근이세요',
        company:       '당근마켓',
        source:        'seed',
        commute_start: '09:30',
    ...
    {
        user_id:       'seed_usr_jang_krafton',
        email:         'seed_jang_krafton@seed.refresheet.local',
        employee_name: '배그하고싶다',
        company:       '크래프톤',
        source:        'seed',
        commute_start: '09:00',
        commute_end:   '18:00',
        profile: {
            label:        '점심후형',
            playHoursKST: [13, 14],
            preferredGames: ['2048', '2048', 'typing_game'],
            skillLevel:   'mid',
            activeDays:   'weekday',
            playFreq:     0.55,
            maxPerDay:    3,
    ...
    {
        user_id:       'seed_usr_ryu_nexon',
        email:         'seed_ryu_nexon@seed.refresheet.local',
        employee_name: '메이플키우기',
        company:       '넥슨',
        source:        'seed',
        commute_start: '09:00',
        commute_end:   '18:00',
        profile: {
            label:        '야간게임형',
            playHoursKST: [20, 21, 22],
            preferredGames: ['2048', '2048', '2048'],
            skillLevel:   'low_mid',
            activeDays:   'all',
            playFreq:     0.45,
            maxPerDay:    3,
    ...
    {
        user_id:       'seed_usr_moon_ncsoft',
        email:         'seed_moon_ncsoft@seed.refresheet.local',
        employee_name: '리니지좀그만',
        company:       '엔씨소프트',
        source:        'seed',
        commute_start: '09:00',
        commute_end:   '18:00',
    ...
    {
        user_id:       'seed_usr_ko_cjenm',
        email:         'seed_ko_cjenm@seed.refresheet.local',
        employee_name: '막내PD입니다',
        company:       'CJ ENM',
        source:        'seed',
        commute_start: '08:00',
        commute_end:   '19:00',
    ...
    {
        user_id:       'seed_usr_yang_lotte',
        email:         'seed_yang_lotte@seed.refresheet.local',
        employee_name: '롯데카드멤버',
        company:       '롯데정보통신',
        source:        'seed',
        commute_start: '09:00',
        commute_end:   '18:00',
    ...
    {
        user_id:       'seed_usr_bae_gs',
        email:         'seed_bae_gs@seed.refresheet.local',
        employee_name: '편의점사장님',
        company:       'GS리테일',
        source:        'seed',
        commute_start: '07:00',
        commute_end:   '23:00',
    ...
    {
        user_id:       'seed_usr_hong_shinhan',
        email:         'seed_hong_shinhan@seed.refresheet.local',
        employee_name: '대출상담사',
        company:       '신한은행',
        source:        'seed',
        commute_start: '08:30',
        ...
        profile: {
            label:        '숫자강자형',
            playHoursKST: [10, 11],
            preferredGames: ['sudoku', 'sudoku', 'sudoku', 'sudoku'],
            skillLevel:   'high',
            activeDays:   'weekday',
            playFreq:     0.65,
            maxPerDay:    4,
    ...
    {
        user_id:       'seed_usr_nam_posco',
        email:         'seed_nam_posco@seed.refresheet.local',
        employee_name: '철강왕후보생',
        company:       '포스코',
        source:        'seed',
        commute_start: '08:00',
        commute_end:   '17:00',
    ...
    {
        user_id:       'npc_usr_hr_bot',
        email:         'npc_hr_bot@seed.refresheet.local',
        employee_name: '인사봇',
        company:       'Refresheet Lab',
        source:        'npc',
        commute_start: '00:00',
    ...
    {
        user_id:       'npc_usr_sales_bot',
        email:         'npc_sales_bot@seed.refresheet.local',
        employee_name: '영업봇',
        company:       'Refresheet Lab',
        source:        'npc',
        commute_start: '00:00',
    ...
    {
        user_id:       'npc_usr_night_owl',
        email:         'npc_night_owl@seed.refresheet.local',
        employee_name: '올빼미NPC',
        company:       'Refresheet Lab',
        source:        'npc',
        commute_start: '00:00',
        commute_end:   '23:59',
        profile: {
            ...
            preferredGames: ['sudoku', 'typing_game'],
            skillLevel:   'mid',
            activeDays:   'npc_todaki',
            playFreq:     0.60,
            maxPerDay:    2,
        },
    },
    {
        user_id:       'npc_usr_intern_bot',
        email:         'npc_intern_bot@seed.refresheet.local',
        employee_name: '인턴봇',
        company:       'Refresheet Lab',
        source:        'npc',
        commute_start: '00:00',
    ...
    {
        user_id:       'npc_usr_cs_bot',
        email:         'npc_cs_bot@seed.refresheet.local',
        employee_name: 'CS봇',
        company:       'Refresheet Lab',
        source:        'npc',
        commute_start: '00:00',
    ...
    {
        user_id:       'npc_usr_weekend_bot',
        email:         'npc_weekend_bot@seed.refresheet.local',
        employee_name: '주말알바NPC',
        company:       'Refresheet Lab',
        source:        'npc',
        commute_start: '00:00',
        commute_end:   '23:59',
